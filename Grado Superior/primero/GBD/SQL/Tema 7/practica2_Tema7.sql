...
select emp_no as 'Numero empleado', apellido,oficio
from empleados
...
select emp_no as 'Numero empleado', apellido,oficio,salario
from empleados
...
select emp_no as 'Numero empleado',apellido,dep_no
from empleados
where dep_no not in (select dep_no
                     from departamentos
                     where localidad = 'MADRID' or localidad='BARCELONA'
                     );
...
select dnombre 
from departamentos
where dep_no like (select dep_no
                   from empleados
...
select emp_no as 'Numero  empleado',apellido,salario
from empleados
